      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-text-muted">
            Turn systemic sustainability into internal company gamification.
          </p>
        </div>
          ...
          <div className="relative overflow-hidden bg-brand-primary rounded-[32px] p-8 text-text-on-dark min-h-[200px] flex items-center shadow-lg">
            ...
            <div className="relative z-10 w-full max-w-lg">
              ...
              <p className="text-brand-accent-amber font-medium">
                Tim Front-End bulan ini berhasil menghemat energi 10% lebih
                banyak dari Tim Desain!
              </p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-surface-canvas border border-brand-accent-teal/30 rounded-2xl">
                <div className="flex items-center gap-4">
                  <div className="w-8 h-8 rounded-full bg-brand-accent-teal/10 text-brand-accent-teal font-bold flex items-center justify-center font-serif text-sm">
                    1
                  </div>
                  <div>
                    <div className="font-bold text-text-ink">Frontend Team</div>
                    <div className="text-xs text-brand-accent-teal">
                      +18% Efficiency Goal
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-surface-canvas border border-surface-hairline rounded-2xl">
                <div className="flex items-center gap-4">
                  <div className="w-8 h-8 rounded-full bg-surface-soft text-text-muted font-bold flex items-center justify-center font-serif text-sm">
                    2
                  </div>
                  <div>
              ...
              <div className="flex items-center justify-between p-4 bg-surface-canvas border border-surface-hairline rounded-2xl opacity-80">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-brand-accent-amber">
                      -4% Efficiency Goal
                    </div>
                  </div>
                </div>
        ...
        <div className="md:col-span-4 flex flex-col gap-6">
          <div className="bg-surface-dark text-text-on-dark rounded-3xl p-6 border border-surface-dark-elevated">
            ...
            <p className="text-sm text-text-on-dark-soft mb-6 leading-relaxed">
              By making efficiency visible, you encourage organic sustainable
              practices among team members without micromanagement.
            </p>
          ...
          <div className="flex-1 min-h-[300px]">
            <div className="bg-surface-card rounded-3xl p-6 border border-surface-hairline h-full flex flex-col justify-center items-center text-center">
              ...
              <p className="text-sm text-text-muted">
                Total kWh saved company-wide through gamification this month.
              </p>
            </div>
          </div>
        </div>
