  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-serif font-bold italic text-text-ink mb-1">Eco-Leaderboard</h1>
          <p className="text-sm text-text-muted">Turn systemic sustainability into internal company gamification.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mt-8">
        <div className="md:col-span-8 flex flex-col gap-6">
           <div className="relative overflow-hidden bg-brand-primary rounded-[32px] p-8 text-text-on-dark min-h-[200px] flex items-center shadow-lg">
             <div className="absolute right-0 top-0 w-64 h-64 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/4 blur-2xl"></div>
           ...
           <div className="bg-surface-card rounded-3xl p-6 border border-surface-hairline">
             <h3 className="text-[11px] font-bold uppercase tracking-widest text-brand-primary mb-6">Detailed Rankings</h3>
             ...
             <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-surface-canvas border border-brand-accent-teal/30 rounded-2xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-bold text-text-ink">Frontend Team</div>
                      <div className="text-xs text-brand-accent-teal">+18% Efficiency Goal</div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-text-ink">-450 kWh</div>
                    <div className="text-[10px] uppercase text-text-muted-soft">Saved</div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-surface-canvas border border-surface-hairline rounded-2xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-brand-primary">+12% Efficiency Goal</div>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex items-center justify-between p-4 bg-surface-canvas border border-surface-hairline rounded-2xl opacity-80">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-bold text-text-ink">DevOps Infrastructure</div>
                      <div className="text-xs text-brand-accent-amber">-4% Efficiency Goal</div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-text-ink">+80 kWh</div>
                    <div className="text-[10px] uppercase text-text-muted-soft">Over limit</div>
                  </div>
                </div>
             </div>
           </div>
        ...
        <div className="md:col-span-4 flex flex-col gap-6">
           <div className="bg-surface-dark text-text-on-dark rounded-3xl p-6 border border-surface-dark-elevated">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold">Public Dashboard</h3>
              </div>
              <p className="text-sm text-text-on-dark-soft mb-6 leading-relaxed">
                By making efficiency visible, you encourage organic sustainable practices among team members without micromanagement.
              </p>
              <div className="p-3 bg-surface-dark-elevated rounded-xl flex items-center justify-between border border-surface-hairline/10">
                <span className="text-xs text-brand-primary truncate mr-2">ecometer.id/p/leaderboard/49a...</span>
                <span className="text-[10px] uppercase font-bold text-brand-accent-teal bg-brand-accent-teal/10 px-2 py-1 rounded">Live</span>
              </div>
           </div>
           
           <div className="flex-1 min-h-[300px]">
             {/* Re-use the existing component for visual consistency or just show a stat */}
             <div className="bg-surface-card rounded-3xl p-6 border border-surface-hairline h-full flex flex-col justify-center items-center text-center">
                 ...
                 <h3 className="text-3xl font-serif font-bold text-text-ink mb-2">1,240</h3>
                 <p className="text-sm text-text-muted">Total kWh saved company-wide through gamification this month.</p>
             </div>
           </div>
        </div>
      </div>
