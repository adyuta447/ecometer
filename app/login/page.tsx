    ...
    <div className="min-h-screen bg-surface-canvas flex flex-col items-center justify-center p-4 font-sans">
      <div className="w-full max-w-md bg-surface-card border border-surface-hairline rounded-[32px] p-8 shadow-xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-serif italic text-brand-primary mb-2">EcoMeter.</h1>
          <p className="text-sm text-text-muted">Sign in to your operational dashboard.</p>
        </div>
        ...
        <p className="text-center text-sm text-text-muted mt-8">
          Don't have an account? <Link href="/register" className="text-brand-primary font-bold hover:underline">Register here</Link>
        </p>
      </div>
    </div>
  );
